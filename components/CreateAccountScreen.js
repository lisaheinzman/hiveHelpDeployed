...
import BackgroundImage from "../assets/createAccount.png";
...
const CreateAccountScreen = () => {
  ...
  async function handleSubmit() {
    ...
    if (isValid) {
      alert(
        "Account created! Please check your email for a verification email."
      );
    } else {
    ...
    <View style={styles.imageContainer}>
      <View style={styles.pageContainer}>
        ...
        <View style={styles.container}>
          ...
          />
          {confirmEmailError ? (
            <Text style={{ color: "red" }}>{confirmEmailError}</Text>
          ) : null}
          ...
          <TouchableOpacity
            style={[styles.button, { alignSelf: "center" }, { margin: 5 }]}
            disabled={loading}
